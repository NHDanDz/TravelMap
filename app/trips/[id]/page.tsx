...
import { 
  MapPin, ArrowLeft, Calendar, Users, Clock, Star,
  Edit, Share, Heart, Download, Navigation, Phone,
  Coffee, Hotel, Utensils, Landmark, User, Tag,
  DollarSign, Route, Eye, CheckCircle, AlertCircle
} from 'lucide-react';
